...
if data is None or data.empty:
    st.error("No gold data received. Try again later.")
elif "Close" not in data.columns or data["Close"].isna().all():
    st.error("Gold price data is incomplete or unavailable.")
else:
...
st.markdown("<hr><small style='color:gray;'>Live Gold Signals Dashboard | Developed by ChatGPT</small>", unsafe_allow_html=True)
